...
export async function sendOrderConfirmationEmail(
  ...
  try {
    await resend.emails.send({
      ...
      subject: `Finite Watches - Order confirmation`,
      html: `
      <!DOCTYPE html>
      <html lang="en">
      <head>
                ...
                <tr>
                  <td style="padding: 30px; background-color: #fafafa; text-align: center;">
                    <p style="margin: 0 0 10px; color: #999; font-size: 14px;">
                      ...
                      <a href="mailto:support@finitewatches.com" style="color: #666; text-decoration: none;">
                        support@finitewatches.com
                      </a>
                    </p>
                    
                    <p style="margin: 0; color: #999; font-size: 12px;">
                      © ${new Date().getFullYear()} Finite Watches. All rights reserved.
                    </p>
                  </td>
                </tr>
