...
ALTER TABLE "watches" ADD CONSTRAINT "watches_product_safety_product_safety_info_id_fk" FOREIGN KEY ("product_safety") REFERENCES "public"."product_safety_info"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
