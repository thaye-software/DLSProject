...
export async function WatchCard({ product, customerGeoLocation }: { product: Product, customerGeoLocation : string }) {

  const formattedPrice = await convertPrice(product.priceDkk, customerGeoLocation);
