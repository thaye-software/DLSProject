ALTER TABLE "users" RENAME COLUMN "country" TO "country_id";--> statement-breakpoint
ALTER TABLE "users" RENAME COLUMN "address" TO "address_id";--> statement-breakpoint
...
CREATE INDEX "idx_users_address" ON "users" USING btree ("address_id");