  ...
  if (!foundOrder) {
    return (
      <div>
        <ToastWrapper
          state={{
            message: `Something went wrong no order found for order: ${orderId}...`,
            success: false,
            redirectUrl: "/",
          }}
        />
    ...
    <div className="min-h-screen bg-background py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground mt-12 mb-2">
            Order Confirmed!
          </h1>
          ...
          <div className="flex gap-4 pb-4 border-b">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">
                Qty: {foundOrder.orderItems[0].quantity}
              </p>
            </div>
            <p className="font-semibold text-foreground">{displayItemAmount}</p>
          </div>
