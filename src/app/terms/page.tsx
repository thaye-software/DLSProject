    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="prose max-w-none mb-6">
        <p>
          ...
          the Limited Watches website and services. By using our site or placing
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          "We", "us" and "our" refer to Limited Watches. "You" or "customer"
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          ...
          the property of Limited Watches or its licensors and is protected by
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          To the maximum extent permitted by law, Limited Watches and its
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          You agree to indemnify and hold harmless Limited Watches, its
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          ...
          of the jurisdiction in which Limited Watches is headquartered, without
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          ...
          <a
            ...
            href="mailto:support@limitedwatches.com"
          >
